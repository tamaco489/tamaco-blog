import { Article, Category, Tag, User, ArticleListResponse } from '@/types/blog';
...
const mockUser: User = {
  ...
  bio: 'フロントエンドエンジニア / Next.js & TypeScript',
  role: 'author',
...
// モックタグ
const mockTags: Tag[] = [
  { id: '1', name: 'フロントエンド', slug: 'frontend', created_at: '2024-01-01T00:00:00Z' },
  { id: '2', name: 'プログラミング', slug: 'programming', created_at: '2024-01-01T00:00:00Z' },
  { id: '3', name: 'ウェブ開発', slug: 'web-development', created_at: '2024-01-01T00:00:00Z' },
  { id: '4', name: 'JavaScript', slug: 'javascript', created_at: '2024-01-01T00:00:00Z' },
  { id: '5', name: 'UI/UX', slug: 'ui-ux', created_at: '2024-01-01T00:00:00Z' },
];
...
const mockArticles: Article[] = [
  {
    ...
    excerpt: 'Next.js 13の新機能App Routerの基本的な使い方と従来のPages Routerとの違いについて説明します。',
    status: 'published',
  ...
  },
  {
    ...
    content: 'TypeScriptを使ったReactコンポーネントの効果的な設計パターンを紹介...',
    excerpt: 'TypeScriptの型システムを活用して、より安全で保守性の高いReactコンポーネントを作成する方法を解説します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'useState、useEffect、useContextなどのReact Hooksを使って、効率的な状態管理を実現する方法を紹介します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'TailwindCSSのユーティリティクラスを活用して、モバイルファーストなレスポンシブデザインを効率的に実装する方法を学びます。',
    status: 'published',
  ...
  },
  {
    ...
    content: 'Next.js 14のServer Actionsを使ったフォーム処理について詳しく解説...',
    excerpt: 'Next.js 14で追加されたServer Actionsを使って、型安全なフォーム処理を実装する方法を紹介します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'React Suspenseを活用して、ローディング状態とエラーハンドリングを効率的に管理する方法を解説します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'TypeScript 5.0の新機能であるDecoratorsやconst type parametersなどを紹介し、既存プロジェクトの移行方法を説明します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'React.memoとuseMemo、useCallbackの適切な使い分けとパフォーマンス測定の方法を実例とともに解説します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'Next.jsのISRとSSGの特徴を理解し、プロジェクトの要件に応じた最適な選択方法とパフォーマンスへの影響を解説します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'スクリーンリーダー対応やキーボードナビゲーションなど、誰でも使いやすいWebアプリケーションを作るための基本を学びます。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'GitHub Actionsを活用して、テスト・ビルド・デプロイを自動化するCI/CDパイプラインの構築手順を詳しく解説します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'useLocalStorage、useFetch、useDebounceなど、実用的なカスタムフックの作成方法とベストプラクティスを紹介します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'Next.js Middlewareを使って、認証チェックやA/Bテスト、地域別リダイレクトなどの高度なルーティング制御を実装する方法を説明します。',
    status: 'published',
  ...
  },
  {
    ...
    excerpt: 'Pick、Omit、Partial、Recordなど、TypeScriptのUtilityタイプを活用して、より柔軟で保守性の高い型定義を作成する方法を解説します。',
    status: 'published',
  ...
  },
  {
    ...
    content: 'Reactアプリケーションでのエラーハンドリングのベストプラクティス...',
    excerpt: 'Error BoundaryとSuspenseを組み合わせて、ユーザビリティの高いエラーハンドリングを実装する方法を詳しく解説します。',
    status: 'published',
...
// ページネーション用の記事データ取得関数
export function getMockArticles(page: number = 1, limit: number = 10): ArticleListResponse {
...
export { mockCategories, mockTags, mockUser };